...
insert into clients (name) values ('Microsoft');
...
insert into users (roles, username, firstName, lastName, email, password, sex, position) values ('[\"user\"]','user1', 'Jana', 'Nováková', 'user1@jago.cz', '$2b$10$LUKIS8nCMsRb4oKVqa5RR.w3rZUUr7.JZ0rZaXiZOEu0r7F7v6Aku', 'F', 'Zaměstnanec');
